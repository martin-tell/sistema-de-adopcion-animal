					...
					<tr>
						<?php foreach($d as $m): ?>
							<td style="text-align:center;"> 
								<a href="descripcionU.php?id=<?= $m['id_mascota'] ?>&nmbr=<?= $m['nombre_mascota'] ?>&dd=<?= $m['edad'] ?>&rz=<?= $m['raza'] ?>&dscrp=<?= $m['descripcion'] ?>&ft=<?= $m['foto_mascota'] ?>&spc=<?= $m['especie']?>&fch=<?= $m['fecha_adopcion']?>"> 
